...
TOP_SPEED_TURNING = 10 #velocidade de virada
MIN_SPEED = 4
SCALE = 70
SENS_SCALE = 195
...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        for filename in os.listdir('Saves/Rede2_4-10-3/'):
            if filename.startswith('SavedDriver_+'+CODINOME+'_'):                
                ...
                print(dados[2])
                save = "Saves/Rede2_4-10-3/"+filename
    ...
    def reset_log(self):                        
        #F = open("Logs/Rede2_4-10-3/R2_"+str(amostra)+".txt","a")                               
    ...
    def update(self, delta_time):
        ...
        if(self.resetCount>=self.save):                    
            storage.save(nn, filepath=f'Saves/Rede2_4-10-3/motorista{amostra}_{CODINOME}_g{self.save}_d{self.maxDistance:.0f}.hdf5')
            self.save+= SAVE_SPAN
        '''
